...
extern "C" EXPORT int getPluginInfo(int index, Plugin::PluginInfo* info)
{
	...
	case 0:
		...
		//Processor name
		info->processor.name = "Ch-interp"; //Processor name shown in the GUI
		...
		info->processor.type = ProcessorType::UtilityProcessor;

		//Class factory pointer. Replace "ProcessorPluginSpace::ProcessorPlugin" with the namespace and class name.
		info->processor.creator = &(Plugin::createProcessor<ChInterpSpace::ChInterp>);
		break;
		/**
